...
if( isset($_POST['submit']) && $_POST['submit'] == 'laudes' ) {
...
if(isset($hasError)) { //If errors are found
	...
	echo '<div class="alert-box alert">' . $custom_error . '<a href="" class="close">&times;</a></div>';

} if(isset($emailSent) && $emailSent == true) { //If email is sent successfully

	echo '<div class="alert-box success">' . $custom_success . '<a href="" class="close">&times;</a></div>';
